...
FINETUNE_MODEL_PATH=$FINETUNE_MODEL_DIR/bert_joint_2.pk
...
TEST_DATA_PATH=$FORMAT_DATA_DIR/magic_test_filter.txt

# 日志
LOG_FILE=$LOG_DIR/bert_joint_test_magic_test.txt

nohup python -u run_model/run_bert_joint_correction.py \
  --do_train \
