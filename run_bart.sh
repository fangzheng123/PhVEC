...
####################用户需提供的数据#####################
# 模型训练、验证、测试文件
FORMAT_DATA_DIR=$ROOT_DIR/format_data
TRAIN_DATA_PATH=$FORMAT_DATA_DIR/tmp_sent.txt
DEV_DATA_PATH=$FORMAT_DATA_DIR/tmp_sent.txt
TEST_DATA_PATH=$FORMAT_DATA_DIR/dev_single_sent.txt
...
nohup /opt/compiler/gcc-4.8.2/lib/ld-linux-x86-64.so.2 --library-path /opt/compiler/gcc-4.8.2/lib \
/ssd1/users/fangzheng/3.6.5/bin/python -u run_model/run_bart_correction.py \
  --do_train \
